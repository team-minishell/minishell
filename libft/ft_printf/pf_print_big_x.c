...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/03/03 15:51:21 by yochoi            #+#    #+#             */
/*   Updated: 2020/05/08 18:19:02 by yochoi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	print_big_x2(t_struct *ptr, int output_len, int len, char *str)
{
	if (!ptr->minus)
	{
...
void		print_big_x(t_struct *ptr)
{
	...
	if (str[0] == '0' && ptr->precision == 0 && ptr->dot == true)
	{
		...
		print_big_x2(ptr, output_len, len, str);
	reset_struct(ptr);
	return (free(str));
}
